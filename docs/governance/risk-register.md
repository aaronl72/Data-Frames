...
| R-08 | Wazuh manager | Unpatched vulnerability in the SIEM itself disables or blinds logging right when it's needed most | 2 | 4 | 8 | Medium | Planned: patch cadence defined once the VM is built (network architecture phase) | Mitigate | Not yet built |
